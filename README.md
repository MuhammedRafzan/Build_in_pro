...
##**Dataset Information**
-Contains labeled hand gesture samples
-Features extracted from hand landmark coordinates
...
##**Acknowledgments**
Special thanks to open-source libraries and tools that supported the development of this project.
